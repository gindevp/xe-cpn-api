...
public class OrderItemAsserts {
    ...
    public static void assertOrderItemUpdatableFieldsEquals(OrderItem expected, OrderItem actual) {
        assertThat(expected)
            ...
            .satisfies(e ->
                assertThat(e.getLengthCm()).as("check lengthCm").usingComparator(bigDecimalCompareTo).isEqualTo(actual.getLengthCm())
            )
            .satisfies(e ->
                assertThat(e.getWidthCm()).as("check widthCm").usingComparator(bigDecimalCompareTo).isEqualTo(actual.getWidthCm())
            )
            .satisfies(e ->
                assertThat(e.getHeightCm()).as("check heightCm").usingComparator(bigDecimalCompareTo).isEqualTo(actual.getHeightCm())
            )
            .satisfies(e ->
                assertThat(e.getDeclaredValueAmount())
                    .as("check declaredValueAmount")
                    .usingComparator(bigDecimalCompareTo)
                    .isEqualTo(actual.getDeclaredValueAmount())
            )
            .satisfies(e ->
