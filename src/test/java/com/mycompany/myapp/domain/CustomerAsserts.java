...
public class CustomerAsserts {
    ...
    public static void assertCustomerUpdatableFieldsEquals(Customer expected, Customer actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getLastOrderAt()).as("check lastOrderAt").isEqualTo(actual.getLastOrderAt()))
            .satisfies(e -> assertThat(e.getOrderCount()).as("check orderCount").isEqualTo(actual.getOrderCount()))
